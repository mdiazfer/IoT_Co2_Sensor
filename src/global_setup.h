...
#define BUILD_TYPE_SENSOR_CASE_2  3
...
#define POWER_DIS 0.850  //Watts - Power generated by board, sensor, etc - P=V*I (5*0,170) - Estimated
...
#define VOLTAGE_TH_STATE  2150 //2150 //mv - Threshold to consider USB or BAT power
...
#if BUILD_ENV_NAME==BUILD_TYPE_SENSOR_CASE_2
  #ifndef _BUILD_TYPE_SENSOR_CASE_2_
    #define eNum  2.718281828459045
    enum calibrationStates {bootUpState,usbOffDisplayOffTransition,usbOffDisplayOffStable,usbOffDisplayOnTransition,usbOffDisplayOnStable,
                            usbOnDisplayOffTransition,usbOnDisplayOffStable,usbOnDisplayOnTransition,usbOnDisplayOnStable};
    //bootUpState,usbOffDisplayOffTransition,usbOffDisplayOffStable,usbOffDisplayOnTransition,usbOffDisplayOnStable,usbOnDisplayOffTransition,usbOnDisplayOffStable,usbOnDisplayOnTransition,usbOnDisplayOnStable
    /*
    static const float_t calibrationTemM[] = {1,-0.234090423,0.97916585,0.264652445,0.968069795,-0.26368421,0.976231813,0.011293649,0.882474144};
    static const float_t calibrationTemB[] = {0,34.99315515,0.332392527,20.24580056,-0.77203377,34.35894398,-1.031987844,25.56290936,1.330409562};
    static const float_t calibrationTemM[] = {1,1,0.97916585,1,0.968069795,1,0.976231813,1,0.882474144};
    static const float_t calibrationTemB[] = {0,0,0.332392527,0,-0.77203377,0,-1.031987844,0,1.330409562};
    static const float_t calibrationHumM[] = {1,-0.19675018,0.832015856,0.523900103,1.102785486,-0.015756863,1.291058119,1.401883024,1.208210144};
    static const float_t calibrationHumB[] = {0,42.33829999,5.805231968,17.15810973,-0.252734363,34.09801996,-6.672133507,-14.93400902,-3.148263475};
    static const uint64_t transitionEndTime[] = {60000,3000000,3000000,3000000,3000000,3000000,3000000,3000000,3000000}; //50 min
    //static const uint64_t transitionEndTime[] = {15000,15000,15000,15000,15000,15000,15000,15000,15000}; //15 sec
    */
    
    static const float_t calibrationTemM[4][4]={{0.97916585,0.968069795,0.976231813,0.835063409},{0.97916585,0.968069795,0.976231813,0.835063409},{0.97916585,0.968069795,0.976231813,0.835063409},{0.97916585,0.968069795,0.976231813,0.835063409}};
    static const float_t calibrationTemB[4][4]={{0.332392527,-0.77203377,-1.031987844,2.367788762},{0.332392527,-0.77203377,-1.031987844,2.367788762},{0.332392527,-0.77203377,-1.031987844,2.367788762},{0.332392527,-0.77203377,-1.031987844,2.367788762}};
    static const float_t calibrationTemK[4][4]={{0,0.00045,0.00015,0.0005},{0.0005,0,0.00005,0.0015},{0.0005,0.00001,0,0.0005},{0.0005,0.001,0.0003,0}};
    static const float_t calibrationTemC[4][4]={{0,1.493880514,2.966162675,1.562890695},{-1.53705705,0,-0.428926765,0.532032057},{-1.047624762,-0.386024338,0,0.250576042},{-1.752160824,-0.338915863,-1.736489946,0}};
    static const float_t calibrationHumM[4][4]={{0.832015856,1.401883024,1.401883024,1.401883024},{-0.19675018,1.102785486,1.401883024,1.401883024},{-0.19675018,1.401883024,1.291058119,1.401883024},{-0.19675018,-0.19675018,-0.19675018,1.208210144}};
    static const float_t calibrationHumB[4][4]={{5.805231968,-14.93400902,-14.93400902,-14.93400902},{42.33829999,-0.252734363,-14.93400902,-14.93400902},{42.33829999,-14.93400902,-6.672133507,-14.93400902},{42.33829999,42.33829999,42.33829999,-3.148263475}};
    static const uint64_t transitionEndTime[] = {60000,3000000,3000000,3000000,3000000,3000000,3000000,3000000,3000000}; //50 min

    #define _BUILD_TYPE_SENSOR_CASE_2_
  #endif
#endif
