...
public:
	...
	BLECharacteristicCallbacks* getCallbacks(void);
	...
	//Additions
	BLEDescriptorMap* getDescriptorMap(); //To print all the elements in the Map
	void recreateCharacteristicGATTTable(BLEService* pService);
