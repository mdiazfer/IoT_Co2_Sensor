...
public:
	...
	bool 						addService(BLEService* pService);
	BLEAdvertising* getAdvertising();
	void            setCallbacks(BLEServerCallbacks* pCallbacks);
	BLEServerCallbacks* getCallbacks(void);
	...
	//Adittions
	BLEServiceMap* getServiceMap(); //To print all the Services in the Map
	void recreateServerGATTTable();
