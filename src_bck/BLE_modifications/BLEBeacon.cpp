...
char* BLEBeacon::getPtrData() {
	return (char*) &m_beaconData;
} // getPtrData

size_t BLEBeacon::getSizeData() {
	return sizeof(m_beaconData);
}
...
uint8_t BLEBeacon::getSubType() {
	return m_beaconData.subType;
}

uint8_t BLEBeacon::getSubTypeLength() {
	return m_beaconData.subTypeLength;
}
