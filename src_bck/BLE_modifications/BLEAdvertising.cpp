...
std::string BLEAdvertising::getData() {
	return std::string((char*) &m_advData, sizeof(m_advData));
} // getData

char* BLEAdvertising::getPtrData() {
	return (char*) &m_advData;
} // getPtrData

size_t BLEAdvertising::getSizeData() {
	return sizeof(m_advData);
}

esp_ble_adv_data_t* BLEAdvertising::getPtrAdvData() {
	return &m_advData;
}

esp_ble_adv_data_t* BLEAdvertising::getPtrScanRespData() {
	return &m_scanRespData;
}

esp_ble_adv_params_t* BLEAdvertising::getPtrAdvParams() {
	return &m_advParams;
}

size_t BLEAdvertising::getSizeParam() {
	return sizeof(m_advParams);
}

bool* BLEAdvertising::getCustomAdvData() {
	return &m_customAdvData;
}

bool* BLEAdvertising::getCustomScanResponseData() {
	return &m_customScanResponseData;
}

bool* BLEAdvertising::getScanResp() {
	return &m_scanResp;
}
...
/**
 * @brief Print out all service uuid
 * @result [out] print all the servies uuids
 */
std::vector<BLEUUID> BLEAdvertising::vectorServiceUUIDs(void) {
	return m_serviceUUIDs;
} // printAllServiceUUIDs
...
char* BLEAdvertisementData::getPtrData() {
	char* c = const_cast<char*>(m_payload.c_str());
	return c;
} // getPtrData

size_t BLEAdvertisementData::getSizeData() {
